        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="group bg-slate-800/50 backdrop-blur-sm rounded-2xl p-8 border border-slate-700 hover:border-slate-600 transition-all duration-300 hover:-translate-y-2">
              ...
              <h3 className="text-xl sm:text-2xl font-semibold mb-4">{t.industrialCargo}</h3>
            ...
            <div className="group bg-slate-800/50 backdrop-blur-sm rounded-2xl p-8 border border-slate-700 hover:border-slate-600 transition-all duration-300 hover:-translate-y-2">
              ...
              <h3 className="text-xl sm:text-2xl font-semibold mb-4">{t.expressDelivery}</h3>
              <p className="text-slate-400 leading-relaxed">
            ...
            <div className="group bg-slate-800/50 backdrop-blur-sm rounded-2xl p-8 border border-slate-700 hover:border-slate-600 transition-all duration-300 hover:-translate-y-2">
              ...
              <h3 className="text-xl sm:text-2xl font-semibold mb-4">{t.secureTransport}</h3>
              <p className="text-slate-400 leading-relaxed">
                {t.secureDescription}
              </p>
            </div>
      ...
      <section className="relative bg-slate-800 py-24 px-4 sm:px-6">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div className="group">
              <div className="text-3xl sm:text-4xl font-bold text-blue-400 mb-2 group-hover:scale-110 transition-transform">10K+</div>
              <div className="text-slate-400 text-sm sm:text-base">{t.shipmentsDelivered}</div>
            </div>
            <div className="group">
              <div className="text-3xl sm:text-4xl font-bold text-orange-400 mb-2 group-hover:scale-110 transition-transform">25+</div>
              <div className="text-slate-400 text-sm sm:text-base">{t.countriesServed}</div>
            </div>
            <div className="group">
              <div className="text-3xl sm:text-4xl font-bold text-green-400 mb-2 group-hover:scale-110 transition-transform">99.8%</div>
              <div className="text-slate-400 text-sm sm:text-base">{t.onTimeDelivery}</div>
            </div>
            <div className="group">
              <div className="text-3xl sm:text-4xl font-bold text-purple-400 mb-2 group-hover:scale-110 transition-transform">15+</div>
              <div className="text-slate-400 text-sm sm:text-base">{t.yearsExperience}</div>
            </div>
          </div>
        </div>
      </section>
